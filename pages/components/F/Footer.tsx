...
const Footer = () => {
    return (
        <footer className="w-full h-auto bg-purple-200 flex justify-around py-6">
            ...
            <div className="recent">
                ...
                <div className="pics pt-3">
                    ...
                    <p className='flex gap-2 text-black cursor-pointer items-center'>
            ...
            <div className="address grid">
                ...
                <b className="text-black pt-3 grid">
                    <p className='flex items-center gap-2'>
                        <b><FaBlenderPhone /></b>
                        <b>Phone:</b>
                    </p>
