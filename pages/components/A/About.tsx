...
const About = () => {
  return (
    <section>
      ...
      <div className="aboutus grid justify-center bg-purple-200 w-full px-10 py-12 h-auto">
        ...
        <div className="portions flex gap-8 mt-4 flex-wrap justify-center">
          <div className="new-class h-auto w-80 rounded-3xl items-center px-5 pb-5 pt-12 shadow-lg shadow-gray-400 relative content-center bg-purple-500 grid justify-center justify-items-center">
          ...
          <div className="new-class h-auto w-80 rounded-3xl items-center px-5 pb-5 pt-12 shadow-lg shadow-gray-400 relative content-center bg-purple-300 grid justify-center justify-items-center">
